...
public interface MappingDataWalkerTokenTypes {
	int EOF = 1;
	...
	int DIGIT = 96;
	int ASTERISK = 97;
	int INVERSE_ATTRIBUTE_CONSTRAINT = 98;
	int INVERSE_ATTRIBUTE_CONSTRAINT_SELECT = 99;
	int AGGREGATE_MEMBER_CONSTRAINT = 100;
	int ATTRIBUTE_INVERSE_ONLY = 101;
	int AGGREGATE_MEMBER_INVERSE_ONLY = 102;
	int STRING_CONSTRAINT = 103;
	int REAL_CONSTRAINT = 104;
	int ENUMERATION_CONSTRAINT = 105;
	int PATH_CONSTRAINT = 106;
	int BOOLEAN_CONSTRAINT = 107;
	int INTEGER_CONSTRAINT = 108;
	int LOGICAL_CONSTRAINT = 109;
	int SELECT_CONSTRAINT = 110;
	int SELECT_DATA_TYPE = 111;
	int INSTANCE_EQUAL = 112;
	int TYPE_CONSTRAINT = 113;
	int ENTITY_CONSTRAINT = 114;
	int AND_CONSTRAINT = 115;
	int OR_CONSTRAINT = 116;
	int INTERSECTION_CONSTRAINT = 117;
	int END_OF_PATH_CONSTRAINT = 118;
}
